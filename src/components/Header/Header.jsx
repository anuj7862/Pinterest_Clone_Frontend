  ...
  return (
    <div className="header">
      ...
      <div className="left-side">
        ...
        <span className="header-screen">Today</span>
        <span className="header-screen">Watch</span>
        <span className="header-screen">Explore</span>
      </div>
      ...
      <div className="right-side">
        ...
        <span className="header-btn login">Login</span>
        <span className="header-btn signup">Signup</span>
      </div>
    </div>
  );
};
